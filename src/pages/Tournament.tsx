      ...
      <main className="container py-12">
        <div className="mb-8">
          <div className="mb-2 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-primary">
            <BarChart3 className="h-3.5 w-3.5" /> Live Tournament
          </div>
          <h1 className="font-display text-3xl font-bold md:text-4xl">Group Stage</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Real-time standings from FIFA World Cup 2026.
          </p>
        </div>
        ...
        {recent.length > 0 && (
          <section className="mt-12">
            <h2 className="mb-4 font-display text-xl font-bold">Recent Results</h2>
